...
impl IntCodeCPUState {
    fn new(xs: &Vec<i128>, input: &Vec<i128>) -> IntCodeCPUState {
...
pub fn execute_program(xs: &Vec<i128>, inp: &Vec<i128>) -> Vec<i128> {
    let mut state = IntCodeCPUState::new(xs, inp);
...
fn main() {
    ...
    println!("Part 1: {}", execute_program(&xs, &vec![1])[0]);
    println!("Part 2: {}", execute_program(&xs, &vec![2])[0]);
}
